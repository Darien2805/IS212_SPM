...
import {Home, Roles, Courses, SkillMaintenance, SkillAssignment, CreateSkill,EasterEgg, LearningJourney, AddCoursesFromLJ} from "./pages"
...
function App() {
  return (
    <BrowserRouter>
      ...
      <Route path={ROUTES.ADDCOURSES} element={<AddCoursesFromLJ />}></Route>
      </Routes>
